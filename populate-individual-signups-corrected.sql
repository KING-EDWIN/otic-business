-- Populate individual_signups table from user_profiles (corrected)
...
-- Show sample data
SELECT id, email, full_name, phone_number, user_id, created_at FROM individual_signups LIMIT 5;
