...
-- ==============================================
-- STEP 4: Create RPC functions with correct signatures
-- ==============================================
...
-- ==============================================
-- STEP 7: Test all functions with specific user
-- ==============================================
...
BEGIN
    ...
    IF test_email IS NOT NULL THEN
        ...
        -- Test 4: Check for existing invitations
        ...
        RAISE NOTICE '🎉 All tests passed for user %!', test_user_id;
    ELSE
