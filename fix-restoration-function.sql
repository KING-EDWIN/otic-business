-- Fix Account Restoration Function
-- This fixes the tier type casting issue

DROP FUNCTION IF EXISTS restore_user_account(UUID, UUID, TEXT);
...
BEGIN
  ...
  -- Restore the user profile with proper type casting
  INSERT INTO user_profiles (
    ...
    deleted_account.user_type,
    CASE 
      WHEN deleted_account.tier = 'free_trial' THEN 'free_trial'::user_tier
      WHEN deleted_account.tier = 'start_smart' THEN 'start_smart'::user_tier
      WHEN deleted_account.tier = 'grow_intelligence' THEN 'grow_intelligence'::user_tier
      WHEN deleted_account.tier = 'enterprise_advantage' THEN 'enterprise_advantage'::user_tier
      ELSE 'free_trial'::user_tier
    END,
