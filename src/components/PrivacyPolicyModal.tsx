      ...
      <DialogContent className="max-w-4xl max-h-[90vh] p-0">
        <DialogHeader className="p-6 pb-0">
          <div className="flex items-center justify-between">
            <DialogTitle className="text-2xl font-bold text-[#040458]">
        ...
        <div className="p-6 border-t">
          <div className="flex items-center space-x-2 mb-4">
            <Checkbox
              ...
              onCheckedChange={(checked) => {
                ...
                if (checked) {
                  // Auto-scroll to bottom to show user has read
                  setTimeout(() => {
            ...
            />
            <label htmlFor="read-checkbox" className="text-sm text-gray-600">
          ...
          <div className="flex items-center space-x-2 mb-4">
            <Checkbox
              ...
              disabled={!hasRead}
            />
            <label htmlFor="accept-checkbox" className="text-sm text-gray-600">
          ...
          <div className="flex justify-end space-x-3">
            ...
            <Button
              ...
              disabled={!isAccepted}
              className="bg-[#040458] hover:bg-[#030345] text-white disabled:opacity-50"
            >
              Accept & Continue
            </Button>
          </div>
