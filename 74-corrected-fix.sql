-- Corrected fix: Drop existing functions first, then create with correct signatures
...
-- Drop existing get_user_invitations function
DROP FUNCTION IF EXISTS get_user_invitations(text);

-- ==============================================
-- STEP 2: Create missing RPC functions with correct signatures
-- ==============================================

-- 1. log_system_error - Create with correct parameter types
...
-- 2. get_user_invitations - Create with correct signature
...
-- ==============================================
-- STEP 3: Fix RLS policies to allow proper access
-- ==============================================
...
BEGIN
    ...
    IF test_user_id IS NOT NULL THEN
        RAISE NOTICE 'Testing corrected functions with user: %', test_user_id;
        ...
        RAISE NOTICE 'All corrected functions tested successfully!';
    ELSE
