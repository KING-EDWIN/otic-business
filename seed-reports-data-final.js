...
// Sample user ID - using the actual user ID found in the products table
...
async function seedReportsData() {
  try {
    ...
    console.log('📝 Using sample user ID:', SAMPLE_USER_ID)
    console.log('⚠️  Note: Make sure this user ID exists in your auth.users table!')
    ...
    if (reportsError) {
      ...
      console.log('💡 Make sure you have created the reports table first!')
      return
    }
    ...
    if (schedulesError) {
      ...
      console.log('💡 Make sure you have created the report_schedules table first!')
      return
    }
    ...
    if (viewsError) {
      ...
      console.log('💡 Make sure you have created the report_views table first!')
      return
    }
