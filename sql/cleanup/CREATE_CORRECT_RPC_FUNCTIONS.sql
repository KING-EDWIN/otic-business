-- Create RPC functions based on actual table structure
...
-- 1. Create create_branch_sale function (using actual branch_sales columns)
...
-- 2. Create add_sale_item function (using actual branch_sale_items columns)
...
-- 3. Create complete_branch_sale function (using actual branch_sales columns)
...
-- 4. Create update_branch_inventory function (using actual branch_inventory columns)
...
-- 5. Create record_staff_attendance function (using actual branch_staff_attendance columns)
...
GRANT EXECUTE ON FUNCTION create_branch_sale(UUID, TEXT, TEXT, TEXT, UUID) TO authenticated;
...
SELECT 'All RPC functions created successfully with correct table structure!' as status;
