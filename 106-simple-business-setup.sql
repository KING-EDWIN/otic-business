-- Simple Business Setup - Run this in Supabase SQL Editor
...
DROP POLICY IF EXISTS "Users can insert their memberships" ON business_memberships;
CREATE POLICY "Users can insert their memberships" ON business_memberships
