-- Fix Multi-Business Management Tables
-- This file fixes the existing tables and creates missing ones

-- First, let's create the missing businesses table
...
-- Fix the business_invitations table to match our code expectations
...
-- Update existing business_invitations data to use the new email column
