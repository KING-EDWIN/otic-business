-- FIX INVITATION SYSTEM TYPE MISMATCH
...
-- 2. Alter existing table columns to text type
...
-- 3. Create get_user_invitations function with correct types
...
BEGIN
    ...
    SELECT 
        ...
        bi.invited_email,
        up.full_name::text as invited_by_name,
        bi.role,
        bi.status,
        bi.message,
        bi.expires_at,
...
SELECT 'Invitation system types fixed successfully!' as status;
